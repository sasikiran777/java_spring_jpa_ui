...
export const AuthorList = () => {
    ...
    return <div className="flex flex-col mt-5 pr-8 pl-8">
        <div className="text-right float-right mt-2 mb-5">
            <button className="rounded bg-blue-500 h-10 pl-8 pr-8 text-white font-bold" onClick={() => navigate('/authors/create')}>Add New Author</button>
        </div>
                ...
                <table className="min-w-full">
                    ...
                    {list.length && list.map((data, key) => {
                        return <tr key={key}>
                            ...
                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div className="text-sm font-medium leading-5 text-gray-500">{data.user.email}</div>
                            </td>
